    ...
    uga = {
        "graph": {
          ...
          "metadata": {
            ...
            "nodeSize": 10,
            "nodeShape": "rectangle",
            "nodeBorderColor": "magenta",
            "nodeBorderSize": 2,
            "nodeLabelColor": "green",
            "nodeLabelSize": 6,
            "nodeHover": "General node hover",
            "nodeClick": "General node click",
            "nodeImage": (
            ...
            "edgeLabelColor": "cyan",
            "edgeLabelSize": 4,
            "edgeHover": "General edge hover",
            "edgeClick": "General edge click",
            "otherMetadata": 42,
          },
          "nodes": [
            {
...
def construct_testdata_graph_tool():
    try:
        ...
        uga.graph_properties['nodeColor'] = uga.new_graph_property('string')
        uga.graph_properties['nodeColor'] = 'green'
        uga.graph_properties['edgeOpacity'] = uga.new_graph_property('double')
        uga.graph_properties['edgeOpacity'] = 0.5
        ...
        dga.graph_properties['nodeColor'] = dga.new_graph_property('string')
        dga.graph_properties['nodeColor'] = 'green'
        dga.graph_properties['edgeOpacity'] = dga.new_graph_property('double')
        dga.graph_properties['edgeOpacity'] = 0.5
        ...
        print('Network creation error:', excp)
        testdata = None
    return testdata
...
def construct_testdata_networkit():
    try:
        ...
        # directed graph with attributes - not supported
        testdata = {
            'undirected': ug,
            'directed': dg,
        }
...
def construct_testdata_networkx():
    try:
        ...
        uga.graph['nodeColor'] = 'green'
        uga.graph['edgeOpacity'] = 0.5
        uga.nodes[0]['size'] = 50
        ...
        dga.add_edge(2, 0)
        dga.graph['label'] = 'Directed graph with attributes'
        dga.graph['nodeColor'] = 'green'
        dga.graph['edgeOpacity'] = 0.5
        dga.nodes[0]['size'] = 50
...
def construct_testdata_snap():
    try:
        ...
        dga.AddEdge(1, 2)
        dga.AddEdge(2, 0)
        dga.AddIntAttrN('size')
        dga.AddStrAttrN('color')
        dga.AddIntAttrDatN(0, 50, 'size')
        dga.AddStrAttrDatN(0, 'red', 'color')
        dga.AddIntAttrE('size')
        dga.AddStrAttrE('color')
        dga.AddIntAttrDatE(0, 10, 'size')
...
TESTDATA_JGF = construct_testdata_jgf()
